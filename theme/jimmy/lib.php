 ...
 * @return string
 */
function theme_jimmy_get_main_scss_content($theme) {
    global $CFG;
    ...
    } else if ($filename && ($presetfile = $fs->get_file($context->id, 'theme_jimmy', 'preset', 0, '/', $filename))) {
    ...
    // jimmy scss.
    $jimmyvariables = file_get_contents($CFG->dirroot . '/theme/jimmy/scss/jimmy/_variables.scss');
    $jimmy = file_get_contents($CFG->dirroot . '/theme/jimmy/scss/default.scss');

    // Combine them together.
    $allscss = $jimmyvariables . "\n" . $scss . "\n" . $jimmy;
 ...
 * @return string
 */
function theme_jimmy_get_extra_scss($theme) {
    $content = '';
 ...
 * @return string
 */
function theme_jimmy_get_pre_scss($theme) {
    $scss = '';
    $configurable = [
 ...
 */
function theme_jimmy_get_precompiled_css() {
    global $CFG;

    return file_get_contents($CFG->dirroot . '/theme/jimmy/style/moodle.css');
}
 ...
 * @return mixed
 */
function theme_jimmy_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    $theme = theme_config::load('jimmy');
