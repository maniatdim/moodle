...
namespace theme_jimmy\output;

use theme_config;
use context_course;
use moodle_url;
use html_writer;
use theme_jimmy\output\core_course\activity_navigation;
...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function body_attributes($additionalclasses = array()) {
        $hasaccessibilitybar = get_user_preferences('themejimmysettings_enableaccessibilitytoolbar', '');
        ...
        $fonttype = get_user_preferences('themejimmysettings_fonttype', '');
        if ($fonttype) {
    ...
    public function get_navbar_callbacks_data() {
        $callbacks = get_plugins_with_function('jimmy_additional_header', 'lib.php');
