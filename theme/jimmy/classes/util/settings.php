...
class settings {
    ...
    public function __construct() {
        $this->theme = theme_config::load('jimmy');
    }
    ...
    public function frontpage_slideshow() {
        ...
        $defaultimage = new \moodle_url('/theme/jimmy/pix/default_slide.jpg');
    ...
    public function frontpage_marketingboxes() {
        if ($templatecontext['displaymarketingbox'] = $this->displaymarketingbox) {
            ...
            $defaultimage = new \moodle_url('/theme/jimmy/pix/default_markegingicon.svg');
