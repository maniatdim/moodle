...
class accessibility extends external_api {
    ...
    public static function savethemesettings($formdata) {
        ...
        if ($data['fonttype'] && in_array($data['fonttype'], ['default', 'odafont'])) {
            ...
            set_user_preference('themejimmysettings_fonttype', $fonttype);
        }
        ...
        set_user_preference('themejimmysettings_enableaccessibilitytoolbar', $enableaccessibilitytoolbar);

        \core\notification::success(get_string('themesettingg:successfullysaved', 'theme_jimmy'));
    ...
    public static function getthemesettings() {
        return [
            'fonttype' => get_user_preferences('themejimmysettings_fonttype', 'default'),
            'enableaccessibilitytoolbar' => get_user_preferences('themejimmysettings_enableaccessibilitytoolbar', false)
        ];
    }
