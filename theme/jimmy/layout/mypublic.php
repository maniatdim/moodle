...
/**
 * A drawer based layout for the jimmy theme.
 *
 * @package    theme_jimmy
...
$templatecontext = [
    ...
    'headerbuttons' => \theme_jimmy\util\extras::get_mypublic_headerbuttons($context, $user),
    'editprofileurl' => \theme_jimmy\util\extras::get_mypublic_editprofile_url($user, $courseid),
...
$themesettings = new \theme_jimmy\util\settings();

$templatecontext = array_merge($templatecontext, $themesettings->footer());

echo $OUTPUT->render_from_template('theme_jimmy/mypublic', $templatecontext);
