...
$THEME->scss = function($theme) {
    return theme_jimmy_get_main_scss_content($theme);
};
...
$THEME->extrascsscallback = 'theme_jimmy_get_extra_scss';
$THEME->prescsscallback = 'theme_jimmy_get_pre_scss';
$THEME->precompiledcsscallback = 'theme_jimmy_get_precompiled_css';
$THEME->yuicssmodules = [];
