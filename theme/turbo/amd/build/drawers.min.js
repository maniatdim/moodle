define("theme_turbo/drawers", [
  ...
  class Drawers {
    constructor(drawerNode) {
      _defineProperty(this, "drawerNode", null),
        ...
        this.drawerNode.classList.contains(CLASSES_SHOW)
          ? this.openDrawer({ focusOnCloseButton: !1 })
          : 1 == this.drawerNode.dataset.forceopen
          ? isSmall() || this.openDrawer({ focusOnCloseButton: !1 })
          : Aria.hide(this.drawerNode),
        isSmall() && disableDrawerTooltips(this.drawerNode),
        ((drawerNode) => {
    ...
    openDrawer() {
      ...
      let { focusOnCloseButton: focusOnCloseButton = !0 } =
        arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
      const pendingPromise = new _pending.default("theme_turbo/drawers:open");
      if (
      ...
      preference &&
        !isSmall() &&
        1 != this.drawerNode.dataset.forceopen &&
        M.util.set_user_preference(preference, !0);
    ...
    closeDrawer() {
      ...
      const pendingPromise = new _pending.default("theme_turbo/drawers:close");
      if (
      ...
      preference &&
        updatePreferences &&
        !isSmall() &&
        M.util.set_user_preference(preference, !1);
      const state = this.drawerNode.dataset.state;
      if (state) {
  ...
  (() => {
    ...
    drawerLayout &&
      drawerLayout.addEventListener("scroll", () => {
        drawerLayout.scrollTop >= window.innerHeight
