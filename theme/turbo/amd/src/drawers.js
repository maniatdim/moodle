...
// The jQuery module is only used for interacting with Turborap 4. It can we removed when MDL-71979 is integrated.
...
const disableButtonTooltip = (button, enableOnBlur) => {
  if (button.hasAttribute("data-original-title")) {
    // The jQuery is still used in Turborap 4. It can we removed when MDL-71979 is integrated.
...
export default class Drawers {
   ...
   *
   * @static
   * @property {String} drawerShow See {@link event:theme_turbo/drawers:show}
   * @property {String} drawerShown See {@link event:theme_turbo/drawers:shown}
   * @property {String} drawerHide See {@link event:theme_turbo/drawers:hide}
   * @property {String} drawerHidden See {@link event:theme_turbo/drawers:hidden}
   */
  static eventTypes = {
    /**
     * An event triggered before a drawer is shown.
     *
     * @event theme_turbo/drawers:show
     * @type {CustomEvent}
     * @property {HTMLElement} target The drawer that will be opened.
     */
    drawerShow: "theme_turbo/drawers:show",

    /**
     * An event triggered after a drawer is shown.
     *
     * @event theme_turbo/drawers:shown
     * @type {CustomEvent}
     * @property {HTMLElement} target The drawer that was be opened.
     */
    drawerShown: "theme_turbo/drawers:shown",

    /**
     * An event triggered before a drawer is hidden.
     *
     * @event theme_turbo/drawers:hide
     * @type {CustomEvent}
     * @property {HTMLElement} target The drawer that will be hidden.
     */
    drawerHide: "theme_turbo/drawers:hide",

    /**
     * An event triggered after a drawer is hidden.
     *
     * @event theme_turbo/drawers:hidden
     * @type {CustomEvent}
     * @property {HTMLElement} target The drawer that was be hidden.
     */
    drawerHidden: "theme_turbo/drawers:hidden",
  };
   ...
   * @returns {module:theme_turbo/drawers}
   */
  ...
  openDrawer({ focusOnCloseButton = true } = {}) {
    const pendingPromise = new Pending("theme_turbo/drawers:open");
  ...
  closeDrawer({ focusOnOpenButton = true, updatePreferences = true } = {}) {
    const pendingPromise = new Pending("theme_turbo/drawers:close");
   ...
   *
   * @param {module:theme_turbo/drawers} comparisonInstance
   */
