 ...
 *
 * @module     theme_turbo/form-display-errors
...
define(["jquery", "core_form/events"], function ($, FormEvent) {
  return {
    ...
    enhance: function (elementid) {
      ...
      if (form && !("turboFormErrorsEnhanced" in form.dataset)) {
        ...
        form.dataset.turboFormErrorsEnhanced = 1;
      }
    },
  };
});
