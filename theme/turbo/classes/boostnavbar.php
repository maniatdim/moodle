...
/**
 * Creates a navbar for turbo that allows easy control of the navbar items.
 *
 * @package    theme_turbo
 * @copyright  2021 Adrian Greeve <adrian@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class turbonavbar implements \renderable {
    ...
    public function __construct(\moodle_page $page) {
        ...
        $this->prepare_nodes_for_turbo();
    }

    /**
     * Prepares the navigation nodes for use with turbo.
     */
    protected function prepare_nodes_for_turbo(): void {
        global $PAGE;
    ...
    /**
     * Get all the turbonavbaritem elements.
     *
     * @return turbonavbaritem[] Turbo navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this turbo navbar
     */
    ...
    /**
     * Remove a turbonavbaritem from the turbo navbar.
     *
     * @param  string|int $itemkey An identifier for the turbonavbaritem
     * @param  int|null $itemtype An additional type identifier for the turbonavbaritem (optional)
     */
    ...
    /**
     * Removes the action from the last item of the turbonavbaritem.
     */
